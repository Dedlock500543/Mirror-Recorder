...
public class GuiMirrorImport extends GuiScreen{
    ...
    private void build(){
        ...
        StyledButton prev=new StyledButton(PREV,x+w-nav*2-6,pageY,nav,20,"\u2039").accent(UiTheme.GRAY)
        ...
        StyledButton next=new StyledButton(NEXT,x+w-nav,pageY,nav,20,"\u203a").accent(UiTheme.GRAY)
        ...
        int footerY=wy+wh-32,pathY=wy+wh-52,listY=wy+55;

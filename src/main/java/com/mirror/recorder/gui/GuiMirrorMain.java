...
public class GuiMirrorMain extends GuiScreen{
    ...
    @Override public void drawScreen(int mx,int my,float pt){
        ...
        int vw=fontRenderer.getStringWidth(ver)+8;UiTheme.chip(fontRenderer,ver,winX+winW-14-vw,winY+13,UiTheme.ACCENT);
    ...
    private void drawInfo(){
        ...
        if(table){
            ...
            UiTheme.infoTable(fontRenderer,labels,values,infoX+12,infoY+26,infoRight-12,infoY+infoH-6);
            UiTheme.endClip();
        }else{

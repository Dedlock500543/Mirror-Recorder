...
public class GuiMirrorSlotContext extends GuiScreen{
    ...
    @Override public void drawScreen(int mx,int my,float pt){
        ...
        fontRenderer.drawString("\u00a7l"+Lang.t("slot.title")+" "+slot,x+12,y+11,UiTheme.TEXT);

...
@SideOnly(Side.CLIENT) public class PathLineRenderer{
    ...
    @SubscribeEvent public void onRenderWorldLast(RenderWorldLastEvent e){
        ...
        net.minecraft.client.renderer.entity.RenderManager rm=mc.getRenderManager();double cx=rm.viewerPosX,cy=rm.viewerPosY,cz=rm.viewerPosZ;int cycle=manager.getPlaybackCycle();float r=config.getPathLineR()/255f,g=config.getPathLineG()/255f,b=config.getPathLineB()/255f,a=config.getPathLineAlpha()/255f;
